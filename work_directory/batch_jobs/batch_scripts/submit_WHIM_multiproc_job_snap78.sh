...
srun python ./make_pipes_5.py TNG300-1 5125 78 70 #$SLURM_ARRAY_TASK_ID #note doubled nodes from 7 -> 14 -> 21 -> 28 -> 42 -> 56 -> 70 on 26/04/22 alongside script change from loading simulation in chunks (doubled from 100 -> 200 -> 300...). If this still works, perhaps double again. If it freezes, change back and investigate further. 
